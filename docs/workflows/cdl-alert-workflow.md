...
*Central Diagnostic Laboratory (CDL) blood results and alerts for NMCB participants—from visit blood draw through data-team processing to nurse–physician follow-up.*
...
| File | Purpose |
| ---- | ------- |
| [Mappings between by-hand and by-machine](../files/cdl-alert-workflow/Mappings%20between%20by-hand%20and%20by-machine.xlsx) | Full CRL comparison when hand vs machine BEPCODEs differ |
...
- [Biobank](../systems/biobank.md) — sample and metadata context
