...
3. The **data scientist** processes both inputs and produces two exports:
  ...
  - **RDL alert file** — results with reference ranges for clinical review; used by physicians and nurses to inform participants of abnormal findings; stored in `analyzed/RDL/RDL_alert/`; categories: normal (`Normal`), abnormal (`Afwijkend`), or alert (`ALERT`)
