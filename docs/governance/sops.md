...
1. Whenever an SOP changes, archive the old one, add new version number to the new one, and add the contributor(s).
2. Every two months, review SOPs to check if they are functioning.
