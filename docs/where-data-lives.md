...
| **SOPs, OMOP, technical docs**                 | Research Drive `data infrastructure/`; withdrawal PDF on [SharePoint / Core Team SOP folder](tasks/sop-withdrawal.md#backup-copies) | Models, pipelines, governance; [Withdrawal SOP](tasks/sop-withdrawal.md) |
| **Withdrawal records (legacy)**                | Research Drive `O.Data Management/5.Withdrawal/` (e.g. old Excel — see SOP)                          | Superseded by LDOT LOF; see [Withdrawal SOP](tasks/sop-withdrawal.md)      |
